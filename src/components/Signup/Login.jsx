  ...
  return (
    <div className=''>
        ...
        <div>
            ...
            <p className='sub-heading'>Not a member? 
        ...
        <div>
            <div className='mt-9'>
                ...
                <div>
                    ...
                    <div>
                        <input id="email" type='email' name="email" autoComplete='email' required className='shadow-sm border-2 py-1.5 rounded-lg px-3 w-full mt-2'></input>
                    </div>
                </div>
                <div className='mt-6'>
                    <label for="password" className='label font-sans'>Password</label>
                    <div>
                        <input id="password" type='password' name="password" autoComplete='password' required className='shadow-sm border-2 py-1.5 rounded-lg px-3 w-full mt-2'></input>
                    </div>
                </div>
                <div className='mt-6 flex justify-between'>
                    ...
                    <div>
                    <a href="#" className="text-blue-700 font-semibold font-sans">Forgot password?</a>
                    </div>
                </div>
                <div className='mt-6'>
                    <button className="py-1.5 px-3 justify-center w-full bg-blue-700 rounded-md text-white font-sans font-semibold" type='submit'>Sign in</button>
                </div>
